...
class inputClass:
    ...
    # lOfCSrcFileAddress = ["~/apx_tool_chain/src/CSrc/main.cpp", "~/apx_tool_chain/src/CSrc/foo.cpp"] 
    lOfCSrcFileAddress = ["~/apx_tool_chain/src/CSrc/main.cpp"]
    generateMakeFile = "YES"
    rootFolder = "~/apx_tool_chain"
    AllInputScenariosInOneFile = "YES"
    AllInputFileOrDirectoryName = "~/apx_tool_chain/all_input_scenarios.txt"
