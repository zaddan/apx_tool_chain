...
def main():
    ...
    for arg in sys.argv[1:]:
        if (arg == "various_inputs"):
            ...
            generateGraph_for_all(points_to_graph, "1/quality", "energy", get_benchmark_name(), "optimal setUp for various prime inputs for ") 
            pylab.savefig("various_inputs.png") #saving the figure generated by generateGraph
            
            points_to_graph = [] 
            get_quality_energy_values("various_inputs_same_setUp.PIK", "+", points_to_graph, limit, lower_bound, upper_bound)
            generateGraph_for_all(points_to_graph, "1/quality", "energy", get_benchmark_name(), "One input optimal setUp imposed on others for ") 
        ...
        if (arg == "various_inputs_alter"):
            for index in range(5): 
                ...
                points_to_graph_2 = [] 
                get_quality_energy_values("various_inputs.PIK", "+", points_to_graph, limit, lower_bound, upper_bound)
                generateGraph_for_all_alternative(points_to_graph, "1/quality", "energy", get_benchmark_name(), 1, 0 , "optimal setUp for various prime inputs for") 
                ...
                pylab.savefig("various_inputs"+str(index)+".png") #saving the figure generated by generateGraph
            """ 
            points_to_graph = [] 
            get_quality_energy_values("pickled_results_all_points.PIK", "+", points_to_graph, limit, lower_bound, upper_bound)
            generateGraph_for_all(points_to_graph, "1/quality", "energy", get_benchmark_name()) 
