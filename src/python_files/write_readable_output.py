import sys
import os
def writeReadableOutput(resultTuple, inputFileNameList, symbolsCollected, fileFullAddress):
    ...
    for i in range(0, len(resultTuple), 1):
        finalResultFileFullAddressP.write("this is the inputFile used: " + inputFileNameList[i] + "\n")
