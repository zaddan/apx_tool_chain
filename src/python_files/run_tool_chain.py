...
def main():
    ...
    print "1.source file address"
    print "2.generate Makefile (with YES or NO)"
    print "3.CBuilderFolder"
    print "***********"
    ...
    CSrcFileAddress = sys.argv[1] #src file to be analyzet
    #executableName = sys.argv[3] #src file to be analyzed
    generateMakeFile = sys.argv[2]
...
#        
    ...
    generateBackup(rootResultFolderBackupName, rootResultFolderName, settings.generatedTextFolderName) #generating a back of the results
