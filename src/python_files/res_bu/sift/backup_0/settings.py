...
# dealingWithPics = True
#mode = "allPermutations" 
# mode = "simulated_annealing"
# mode = lOfParetoPointse = "only_read_values"
#mode = "read_values_and_get_pareto"
mode = "genetic_algorithm"
# numberOfIndividualsToStartWith = 100
outputMode = "non-uniform" #determines how the how put needs to be interpreted
                       #whether each line is gonna contain different kind of output
                       #or the continutation of the output
...
# ---- how to put the sub modules results together
method = "localParetoPieceParetoResult"
#method = "uniqueNoiseParetoResult"
#method = "allPoints"

numberOfIndividualsToStartWith = 7
veryHugeNumber = 100000 #this number determines how big the total number of permutaion can be
...
NGEN = 2 
MU =  6 #number of indi for the next gen
LAMBDA = 4 #number of children
CXPB = 0.7
MUTPB = 0.3
apxLowBound = 0
apxUpBound =  15
...
# NGEN =2 
# MU = 10  #number of indi for the next gen
# LAMBDA = 5 #number of children
# CXPB = 0.7
# MUTPB = 0.3
# apxLowBound = 5
# apxUpBound =  7 
...
lAllApxVersionOfEachOps = [GenOpSpace("bta", 8,[32,33, apxLowBound,apxUpBound, 0,1, 0, 1]), GenOpSpace("btm", 4,[32, 33, apxLowBound, apxUpBound])]
...
lOfParetoSetFileName = "pareto_set_file.txt" 
opIndexSelectedFile = "opIndexSelectedFile.txt"
userInputFile = "inputs.py"

# ---- graphing stuff
runToolChainGenerateGraph = True
runToolChainPlotPareto= True


#---setting the verbosity in the C files 
#you can do this by defining VERBOSE in globals.h
