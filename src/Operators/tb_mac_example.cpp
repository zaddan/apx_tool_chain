...
//	size_t Nia_a1 = 0;
	...
	*/
	...
	cout << "////////////////////////////////////////////////////////" << endl;
	cout << "// Start of Nia_A = " << Nia_a1 << ", " << "Nia_m: " << Nia << "Nia_m2: " << Nia_m2 << " calculation" << endl;
	cout << "////////////////////////////////////////////////////////" << endl;
	...
	err_m1.error_est(m1.err_tbl, in_corr_m1.io, Nia-1, 0, 1);
...
//	double min_th = est_err_min;
	...
	for (t=0.001; t<0.3;t=t+0.005) {

		double sim_mgf_m1p = mgf_cal(err_m1.cal_err.err_dist,t);
		double sim_mgf_m2p = mgf_cal(err_m2.cal_err.err_dist,t);
		double sim_mgf_a1p = mgf_cal(err_a1.cal_err.err_dist,t);

		double sim_mgf_m1m = mgf_cal(err_m1.cal_err.err_dist,-1*t);
		double sim_mgf_m2m = mgf_cal(err_m2.cal_err.err_dist,-1*t);
		double sim_mgf_a1m = mgf_cal(err_a1.cal_err.err_dist,-1*t);
